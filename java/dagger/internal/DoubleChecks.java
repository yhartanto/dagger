...
public final class DoubleChecks {
  ...
  private static final class DoubleCheckImpl<T> implements DoubleCheck<T> {
    private volatile Provider<T> provider;
    private volatile Object instance = UNINITIALIZED;

    private DoubleCheckImpl(Provider<T> provider) {
  ...
  public static <P extends Provider<T>, T> Provider<T> provider(P delegate) {
    ...
    return new DoubleCheckImpl<T>(delegate);
  }
  ...
  public static <P extends Provider<T>, T> Lazy<T> lazy(P provider) {
    ...
    return new DoubleCheckImpl<T>(checkNotNull(provider));
  }
}
