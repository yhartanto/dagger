        ...
        .containsElementsIn(
            compilerMode
                ...
                .addLinesIn(
                    ...
                    "          regularScoped = DoubleChecks.reentrantCheck(regularScoped, local);",
                    "        }",
                    "      }",
                    "    }",
                ...
                .addLinesIn(
                    ...
                    "        DoubleChecks.provider(RegularScoped_Factory.create());",
                    "    this.reusableScopedProvider = ",
                    "        SingleChecks.provider(ReusableScoped_Factory.create());",
                    "    this.reusableProvider = DoubleChecks.provider(",
                    "        (Provider) reusableScopedProvider);",
                    "    this.unscopedProvider = DoubleChecks.provider(",
        ...
        .containsElementsIn(
            compilerMode
                ...
                .addLinesIn(
                    ...
                    "    this.reusableScopedProvider = ",
                    "        SingleChecks.provider(ReusableScoped_Factory.create());",
                    "    this.unscopedProvider = SingleChecks.provider(",
                    "        (Provider) Unscoped_Factory.create());",
                    "  }")
                .addLines( //
                    "}")
        ...
        .containsElementsIn(
            compilerMode
                ...
                .addLinesIn(
                    ...
                    "  @SuppressWarnings(\"unchecked\")",
                    "  private void initialize() {",
                    "    this.subtypeProvider = DoubleChecks.provider(Subtype_Factory.create());",
                    "  }",
                    "",
                    "  @Override",
                ...
                .addLinesIn(
                    ...
                    "          subtype = DoubleChecks.reentrantCheck(subtype, local);",
                    "        }",
                    "      }",
                    "    }",
                    "    return (Object) local;",
        ...
        .containsElementsIn(
            compilerMode
                ...
                .addLinesIn(
                    ...
                    "        SingleChecks.provider(TestModule_ProvideStringFactory.create());",
                    "    this.bindStringProvider =",
                    "        DoubleChecks.provider((Provider) provideStringProvider);",
                    "  }",
                    "",
                    "  @Override",
                    "  public Provider<Object> object() {",
                ...
                .addLinesIn(
                    ...
                    "        if (local instanceof MemoizedSentinel) {",
                    "          local = string();",
                    "          object = DoubleChecks.reentrantCheck(object, local);",
                    "        }",
                    "      }",
                    "    }",
                    "    return (Object) local;",
                    ...
                    "  }",
                    "",
                    "  private final class DoubleCheckSwitchingProvider<T> ",
                    "      implements DoubleCheck<T> {",
                    "    @SuppressWarnings(\"unchecked\")",
                    "    @Override",
                    "    public T get() {",
                    "      switch (id) {",
