    ...
    assertThat(compilation)
        ...
        .containsElementsIn(
            JavaFileObjects.forSourceLines(
                ...
                "          charSequence = DoubleChecks.reentrantCheck(charSequence, local);",
                "        }",
                "      }",
                "    }",
  ...
  public void scopedProviders() {
    JavaFileObject module =
        JavaFileObjects.forSourceLines(
            ...
            "  @Provides",
            "  @Singleton",
            "  static String singletonScoped() {",
            "    return new String();",
            "  }",
            "",
            "  @Provides",
            "  @Reusable",
            "  static long reusableScoped() {",
            "    return 1;",
            "  }",
            "",
            "  @Provides",
    ...
    JavaFileObject component =
        JavaFileObjects.forSourceLines(
            ...
            "@Component(modules = TestModule.class)",
            "interface TestComponent {",
            "  Provider<String> getSingletonScopedProvider();",
            "  Provider<Long> getReusableScopedProvider();",
            "  Provider<Integer> getUnscopedProvider();",
            "}");
    ...
    assertThat(compilation)
        ...
        .containsElementsIn(
            JavaFileObjects.forSourceLines(
                ...
                "",
                "  private volatile Provider<String> singletonScopedProvider;",
                "",
                "  private volatile Long l;",
                "",
                "  private volatile Provider<Long> reusableScopedProvider;",
                "",
                "  private volatile Provider<Integer> unscopedProvider;",
                "",
                ...
                "        local = string;",
                "        if (local instanceof MemoizedSentinel) {",
                "          local = TestModule_SingletonScopedFactory.singletonScoped();",
                "          string = DoubleChecks.reentrantCheck(string, local);",
                "        }",
                "      }",
                "    }",
                "    return (String) local;",
                ...
                "    Object local = l;",
                "    if (local == null) {",
                "      local = TestModule.reusableScoped();",
                "      l = (long) local;",
                "    }",
                "    return (long) local;",
                "  }",
                "",
                "  @Override",
                "  public Provider<String> getSingletonScopedProvider() {",
                "    Object local = singletonScopedProvider;",
                "    if (local == null) {",
                "      local = new DoubleCheckSwitchingProvider<>(0);",
                "      singletonScopedProvider = (Provider<String>) local;",
                "    }",
                "    return (Provider<String>) local;",
                "  }",
                "",
                "  @Override",
                "  public Provider<Long> getReusableScopedProvider() {",
                "    Object local = reusableScopedProvider;",
                "    if (local == null) {",
                "      local = new SingleCheckSwitchingProvider<>(0);",
                "      reusableScopedProvider = (Provider<Long>) local;",
                "    }",
                "    return (Provider<Long>) local;",
                "  }",
                "",
                "  @Override",
                "  public Provider<Integer> getUnscopedProvider() {",
                "    Object local = unscopedProvider;",
                "    if (local == null) {",
                "      local = new SwitchingProvider<>(0);",
                "      unscopedProvider = (Provider<Integer>) local;",
                "    }",
                ...
                "        return (T) DaggerTestComponent.this.string();",
                "        default: throw new AssertionError(id);",
                "      }",
                "    }",
                "  }",
                "",
                "  private final class SingleCheckSwitchingProvider<T> implements SingleCheck<T> {",
                "    @SuppressWarnings(\"unchecked\")",
                "    @Override",
                "    public T get() {",
                "      switch (id) {",
                "        case 0: // java.lang.Long ",
                "        return (T) (Long) DaggerTestComponent.this.l();",
                "        default: throw new AssertionError(id);",
                "      }",
                "    }",
                "  }",
                ...
                "        return (T) (Integer) TestModule.unscoped();",
                "        default: throw new AssertionError(id);",
                "      }",
                "    }",
                "  }",
