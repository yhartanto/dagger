        ...
        .containsElementsIn(
            compilerMode
                ...
                .addLinesIn(
                    ...
                    "          new SwitchingProvider<Binding7>(testComponentImpl, 6));",
                    "      this.binding6Provider = DoubleCheck.provider(",
                    "          new SwitchingProvider<Binding6>(testComponentImpl, 5));",
                    "    }")
                .addLines(
                    "    @Override",
                    "    public Binding1 binding1() {",
                    "      return testComponentImpl.shard2.binding1Provider.get();",
                    "   }",
                    "",
                    "    @Override",
                    "    public Binding2 binding2() {",
                    "      return testComponentImpl.shard1.binding2Provider.get();",
                    "    }",
                    "",
                    "    @Override",
                    "    public Binding3 binding3() {",
                    "      return testComponentImpl.shard1.binding3Provider.get();",
                    "    }",
                    "",
                    "    @Override",
                    "    public Binding4 binding4() {",
                    "      return testComponentImpl.shard1.binding4Provider.get();",
                    "    }",
                    "",
                    "    @Override",
                    "    public Binding5 binding5() {",
                    "      return testComponentImpl.shard1.binding5Provider.get();",
                    "    }",
                    "",
                    "    @Override",
                    ...
                    "      return testComponentImpl.shard2.binding1Provider;",
                    "    }",
                    "",
                    "    @Override",
                    "    public Provider<Binding2> providerBinding2() {",
                    "      return testComponentImpl.shard1.binding2Provider;",
                    "    }",
                    "",
                    "    @Override",
                    "    public Provider<Binding3> providerBinding3() {",
                    "      return testComponentImpl.shard1.binding3Provider;",
                    "    }",
                    "",
                    "    @Override",
                    "    public Provider<Binding4> providerBinding4() {",
                    "      return testComponentImpl.shard1.binding4Provider;",
                    "    }",
                    "",
                    "    @Override",
                    "    public Provider<Binding5> providerBinding5() {",
                    "      return testComponentImpl.shard1.binding5Provider;",
                    "    }",
                    "",
                    "    @Override",
                ...
                .addLinesIn(
                    ...
                    "            new SwitchingProvider<Binding5>(testComponentImpl, 4));",
                    "        this.binding4Provider = DoubleCheck.provider(",
                    "            new SwitchingProvider<Binding4>(testComponentImpl, 3));",
                    "        this.binding3Provider = DoubleCheck.provider(",
                    "            new SwitchingProvider<Binding3>(testComponentImpl, 2));",
                ...
                .addLinesIn(
                    ...
                    "                    testComponentImpl.shard1.binding2Provider));",
                    "      }",
                    "    }")
                .addLinesIn(
                    FAST_INIT_MODE,
                    ...
                    "              testComponentImpl.shard1.binding2Provider.get());",
                    "          case 1: return (T) new Binding2(",
                    "              testComponentImpl.shard1.binding3Provider.get());",
                    "          case 2: return (T) new Binding3(",
                    "              testComponentImpl.shard1.binding4Provider.get());",
                    "          case 3: return (T) new Binding4(",
                    "              testComponentImpl.shard1.binding5Provider.get(),",
                    "              testComponentImpl.shard1.binding2Provider);",
        ...
        .containsElementsIn(
            compilerMode
                ...
                .addLinesIn(
                    ...
                    "      private void initialize(final Dependency dependencyParam) {",
                    "        this.binding3Provider =",
                    "            new Binding3Provider(testComponentImpl.dependency);",
                    "      }",
                    "    }")
                .addLinesIn(
                    FAST_INIT_MODE,
                    ...
                    "      private void initialize(final Dependency dependencyParam) {",
                    "        this.binding3Provider =",
                    "            new SwitchingProvider<>(testComponentImpl, 2);",
                    "      }",
                    "    }",
                    "",
                    "    private static final class SwitchingProvider<T> implements Provider<T> {",
        ...
        .containsElementsIn(
            compilerMode
                ...
                .addLinesIn(
                    ...
                    "                testComponentImpl, testSubcomponentImpl, 2));",
                    "      }",
                    "    }")
                .addLinesIn(
                    FAST_INIT_MODE,
