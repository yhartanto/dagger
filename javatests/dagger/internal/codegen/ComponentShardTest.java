        ...
        .containsElementsIn(
            compilerMode
                ...
                .addLinesIn(
                    ...
                    "              testComponentImpl",
                    "                  .testComponentImplShard.binding2Provider.get());",
                    "          case 1: return (T) new Binding2(",
                    "              testComponentImpl",
                    "                  .testComponentImplShard.binding3Provider.get());",
                    "          case 2: return (T) new Binding3(",
                    "              testComponentImpl",
                    "                  .testComponentImplShard.binding4Provider.get());",
                    "          case 3: return (T) new Binding4(",
                    "              testComponentImpl",
                    "                  .testComponentImplShard.binding5Provider.get(),",
                ...
                .addLinesIn(
                    ...
                    "          new TestComponentImpl.SwitchingProvider<Binding5>(",
                    "              testComponentImpl, 4));",
                    "      this.binding4Provider = DoubleCheck.provider(",
                    "          new TestComponentImpl.SwitchingProvider<Binding4>(",
                    "              testComponentImpl, 3));",
                    "      this.binding3Provider = DoubleCheck.provider(",
                    "          new TestComponentImpl.SwitchingProvider<Binding3>(",
                    "              testComponentImpl, 2));",
                    "      this.binding2Provider = DoubleCheck.provider(",
                    "          new TestComponentImpl.SwitchingProvider<Binding2>(",
                    "              testComponentImpl, 1));",
                    "    }")
                .addLines(
                    "  }",
                ...
                .addLinesIn(
                    ...
                    "          new TestComponentImpl.SwitchingProvider<Binding1>(",
                    "              testComponentImpl, 0));",
                    "    }")
                .build());
  }
        ...
        .containsElementsIn(
            compilerMode
                ...
                .addLinesIn(
                    ...
                    "    private void initialize(final Dependency dependencyParam) {",
                    "      this.binding3Provider =",
                    "          new TestComponentImpl.SwitchingProvider<>(testComponentImpl, 2);",
                    "    }",
                    "  }")
                .build());
  }
        ...
        .containsElementsIn(
            compilerMode
                ...
                .addLinesIn(
                    ...
                    "    private void initialize() {",
                    "      this.binding3Provider = DoubleCheck.provider(",
                    "          new TestSubcomponentImpl.SwitchingProvider<Binding3>(",
