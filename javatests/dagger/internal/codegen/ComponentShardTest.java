    ...
    JavaFileObject generatedComponent =
        JavaFileObjects.forSourceLines(
            ...
            GENERATED_CODE_ANNOTATIONS,
                ...
                "          binding9 = DoubleChecks.reentrantCheck(binding9, local);",
                "        }",
                "      }",
                "    }",
                ...
                "    if (local == null) {",
                "      local = new DoubleCheckSwitchingProvider<>(9);",
                ...
                "            binding10 = DoubleChecks.reentrantCheck(binding10, local);",
                "          }",
                "        }",
                "      }",
                ...
                "      if (local == null) {",
                "        local = new DoubleCheckSwitchingProvider<>(10);",
                ...
                "      if (local == null) {",
                "        local = new DoubleCheckSwitchingProvider<>(19);",
                ...
                "            binding19 = DoubleChecks.reentrantCheck(binding19, local);",
                "          }",
                "        }",
                "      }",
                ...
                "            binding20 = DoubleChecks.reentrantCheck(binding20, local);",
                "          }",
                "        }",
                "      }",
                ...
                "      if (local == null) {",
                "        local = new DoubleCheckSwitchingProvider<>(20);",
